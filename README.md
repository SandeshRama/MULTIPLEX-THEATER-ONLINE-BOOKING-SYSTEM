...
Used angular 10 framework for building single page client application.
Created admin page for user login.
Used Html and Css for front end page.
Utilized Hibernate for mapping an object-oriented domain model to a relational database.
Implemented Spring Boot to create micro services.
Used Servlets to extends our application that is hosted by web servers.
